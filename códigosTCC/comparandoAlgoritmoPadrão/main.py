import pandas as pd
import numpy as np
import time  # Import necessário para o temporizador
...
# Instanciar os três algoritmos
random_forest = RandomForestClassifier(random_state=seed)
svm = SVC(random_state=seed, probability=True)  # Habilitar probabilidade no SVM
...
# Avaliar o RandomForest
rf_results = evaluate_model(random_forest, features_selected, labels, cv)
print_results("Random Forest", rf_results)

# Avaliar o SVM
svm_results = evaluate_model(svm, features_selected, labels, cv)
print_results("SVM", svm_results)

# Avaliar o MLP
mlp_results = evaluate_model(mlp, features_selected, labels, cv)
